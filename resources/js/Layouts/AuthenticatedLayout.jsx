        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <main className="flex max-w-full h-full justify-around">
                <div className="w-1/6 bg-black text-white">
                    ...
                    <p className="mt-3"><Link href="/stars/4/2" className="text-white no-underline  pb-1 px-6 hover:text-red-500">ゆるく<span className="text-yellow-400">★</span>４以上</Link></p>

                    <p className="mt-3"><Link href="/stars/4/3" className="text-white no-underline  pb-1 px-6 hover:text-red-500">ガチで<span className="text-yellow-400">★</span>４以上</Link></p>

                    <p className="mt-3"><Link href="/stars/3/2" className="text-white no-underline  pb-1 px-6 hover:text-red-500">ゆるく<span className="text-yellow-400">★</span>３以上</Link></p>

                    <p className="mt-3"><Link href="/stars/3/3" className="text-white no-underline  pb-1 px-6 hover:text-red-500">ガチで<span className="text-yellow-400">★</span>３以上</Link></p>


                    <p className="mt-3"><Link href="/stars/2/2" className="text-white no-underline  pb-1 px-6 hover:text-red-500">ゆるく<span className="text-yellow-400">★</span>２以下</Link></p>

                    <p className="mt-3"><Link href="/stars/2/3" className="text-white no-underline  pb-1 px-6 hover:text-red-500">ガチで<span className="text-yellow-400">★</span>２以下</Link></p>

                    <p className="mt-3"><Link href="/stars/2/2" className="text-white no-underline  pb-1 px-6 hover:text-red-500">ランダム<span className="text-yellow-400">★</span></Link></p>
