                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-black pt-2">
                    <div className="flex justify-between h-16">
                        <div className="flex hover:text-red-500">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink href={`/admin/mypage/${auth.user.id}`} active={route().current('dashboard')}>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink href="/admin/login" active={route().current('dashboard')}>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink href="/admin/register" active={route().current('dashboard')}>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink href="/admin/search" active={route().current('dashboard')}>
